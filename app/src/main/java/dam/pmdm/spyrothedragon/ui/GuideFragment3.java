...
public class GuideFragment3 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageView speechBalloon = view.findViewById(R.id.speech_balloon2);
        ...
        ((MainActivity) requireActivity()).changeMainSection(R.id.navigation_worlds);
        ...
        btnNext.setOnClickListener(v -> {
            ...
            // Navegar al siguiente fragmento de la guía
            NavController navController = Navigation.findNavController(view);
            navController.navigate(R.id.action_guide3_to_guide4);
        });
    }
