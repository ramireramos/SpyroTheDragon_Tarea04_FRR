...
public class GuideFragment4 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageView speechBalloon = view.findViewById(R.id.speech_balloon3);
        ...
        ((MainActivity) requireActivity()).changeMainSection(R.id.navigation_collectibles);
        ...
        btnNext.setOnClickListener(v -> {
            ...
            // Navegar al siguiente fragmento de la guia
            NavController navController = Navigation.findNavController(view);
            navController.navigate(R.id.action_guide4_to_guide5);
        });
    }
