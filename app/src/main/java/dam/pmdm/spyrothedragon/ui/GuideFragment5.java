...
public class GuideFragment5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_guide5, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageView speechBalloon = view.findViewById(R.id.speech_balloon4);
        ...
        btnNext.setOnClickListener(v -> {
            ...
            navController.navigate(R.id.action_guide5_to_guide6);
